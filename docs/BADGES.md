# AutoWealth AI - GitHub 徽章和统计

以下徽章代码可以直接粘贴到 README.md 中使用。
...
<!-- 版本 -->
![Version](https://img.shields.io/badge/Version-0.17.1-green.svg)
```
...
<!-- 类型检查 -->
[![Type Checked](https://img.shields.io/badge/Type-Checked-blue.svg)]()
```
